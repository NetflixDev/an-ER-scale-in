var Creative = function() {
  this.init = function() {
    ...
    TweenLite.set(View.endFrame.headline, { opacity: 0, scale: 2, delay: 0 });
  ...
  this.play = function() {
    ...
    TweenLite.fromTo(View.endFrame.headline, scaleTime, { opacity: 0, scale: 2 }, { opacity: 1, scale: 1, delay: 0 });
